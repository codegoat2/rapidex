...
import { handleDepositAddresses, handleMyTrades, handleWithdraw, handleSetTerms, handleMyTerms, handleSetPass } from '../commands/exchangerCommands';
import {
  handleBalance,
  handleCredit,
  handleDebit,
...
export async function handleCommand(interaction: ChatInputCommandInteraction): Promise<void> {
  ...
  try {
    switch (commandName) {
      ...
      case 'setpass':            await handleSetPass(interaction);        break;
